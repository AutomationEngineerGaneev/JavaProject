...
//    Для использования статических методов/переменных/класса нам не нужно создавать объект этого класса.
//    Конечно, следует учитывать модификаторы доступа.

    //    Например, у нас есть класс Car с нестатической переменной:
    int km;

    //    И у нас есть класс Car со статической переменной:
    static int km_1;
