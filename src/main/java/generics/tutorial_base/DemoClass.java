...
//Подобно классу generics, мы также можем создать метод, который может использоваться с любым типом данных. Такой класс известен как Generics Method.
//
...
//Здесь параметр типа <T>вставляется после модификатора publicи перед возвращаемым типом void.
//
