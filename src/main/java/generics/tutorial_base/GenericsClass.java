...
//
//int Obj- Здесь параметр типа Т заменяется на Integer. Теперь,GenericsClass работает с целочисленными данными.
//string Obj- Здесь параметр типа Т заменяется на String. Теперь,GenericsClass работает со строковыми данными.
}
