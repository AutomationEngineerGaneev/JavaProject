...
//    }
    ...
    public static void main(String[] args) {
        ...
        // Указываем параметр с маленькой головой
...
//        Когда у нас стоит здесь чистая параметризация, мы сюда можем положить все что угодно
...
//        robot = robot1;
//        мы не можем присвоить данные одной ссылки к другой
