...
//
//<T extends Number>
//Здесь, GenericsClass создается с ограниченным типом. Это означает, чтоGenericsClassможет работать только с типами данных, которые являются дочерними по отношению к Number( Integer, Double, и т. д.).
//
